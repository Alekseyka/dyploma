...
export const specificationData: Specification[] = [
  {
    ...
    materials: [
      ...
      { name: "Вторичний поліетилен", amount: 0.46, unit: "Кілогр" },
      { name: "пісок з відсівів дроблення", amount: 11, unit: "Кілогр" },
      ...
      { name: "Плівка термоусадочна", amount: 0.06, unit: "Кілогр" },
